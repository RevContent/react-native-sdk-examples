...
import RevcontentNativeWidget, {
  RevcontentNativeWidgetForwardRefType
} from '@revcontent/react-native-sdk';
  ...
  return (
    <ScrollView
      ...
      <View style={styles.container}>
        <ThemedText type="title">This is an article heading</ThemedText>
        <ThemedText>
